...
3. Calculate both the upper and lower threshold for an outlier, using the standard Q1 - 1.5 _ IQR formula for the low outliers and Q3 + 1.5 _ IQR formula for the high outliers.
