...
Tokenizers answer: _where are the boundaries between tokens?_ Some examples of tokenizers are `blank`, `camel`, and `class`.
...
Filters answer: _what should each token look like before indexing?_
