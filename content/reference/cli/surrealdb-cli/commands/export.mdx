...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Sets the url of the database server to connect to. Defaults to
        http://127.0.0.1:8000 if not specified
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>Sets master username for the database</td>
    </tr>
    <tr>
      <td>
        `-p` / `--pass`
      ...
      <td>Sets master password for the database</td>
    </tr>
    <tr>
      <td>
        `-t` / `--token`
      ...
      <td>
        Sets the authentication token to use when connecting to the server.
        Connect to SurrealDB using a JWT instead of user credentials
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>Sets the desired namespace in which to export data</td>
    </tr>
    <tr>
      <td>
        `--db`
      ...
      <td>Sets the desired database into which to export data</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The logging level for the command-line tool [default: info] [possible
