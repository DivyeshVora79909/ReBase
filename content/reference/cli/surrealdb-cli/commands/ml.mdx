...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sets the url of the database server to connect to</td>
    </tr>
    <tr>
      <td colspan="2">
        `-u / --user`
    ...
    <tr>
      ...
      <td>Sets the desired namespace in which to import data</td>
    </tr>
    <tr>
      <td colspan="2">
        `--db`
    ...
    <tr>
      ...
      <td>Represents the name of the model that you want to export</td>
    </tr>
    <tr>
      <td colspan="2">
        `--version`
      ...
      <td>Represents the version of the model that you want to export</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sets the path to the file which should be exported</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sets the path to the file which should be imported</td>
    </tr>
  </tbody>
</table>
