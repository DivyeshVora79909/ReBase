...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>installs the latest nightly version of SurrealDB</td>
    </tr>
    <tr>
      <td colspan="2">
        `--alpha`
      ...
      <td>installs the latest alpha version of SurrealDB</td>
    </tr>
    <tr>
      <td colspan="2">
        `--beta`
      ...
      <td>installs the latest beta version of SurrealDB</td>
    </tr>
    <tr>
      <td colspan="2">
        `--version`
      ...
      <td>installs a specific version of SurrealDB</td>
    </tr>
    <tr>
      <td colspan="2">
        `--dry-run`
