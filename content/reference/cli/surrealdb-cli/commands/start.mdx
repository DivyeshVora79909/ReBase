...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Sets the hostname or IP address to listen for connections on</td>
    </tr>
    <tr>
      <td colspan="2">
        `--import-file`
      ...
      <td>
        Path to a SurrealQL (`.surql`) file that will be imported when starting
        the server
      </td>
    </tr>
    <tr>
      ...
      <td>Sets the logging level for the database server</td>
    </tr>
    <tr>
      <td colspan="2">
        `-u` / `--user`
    ...
    <tr>
      ...
      <td>Whether to allow unauthenticated access</td>
    </tr>
    <tr>
      <td colspan="2">
      ...
      <td>Whether to suppress the server name and version headers</td>
    </tr>
    <tr>
      <td colspan="2">
        `--temporary-directory`
      ...
      <td>Sets the directory for storing temporary database files</td>
    </tr>
    <tr>
      <td colspan="2">
        `--allow-experimental`
      ...
      <td>
        Sets the experimental capabilities to the experimental capabilities you
        want to allow.
      </td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <a href="/docs/reference/query-language/statements/define/bucket">
          DEFINE BUCKET
        </a>
      </td>
      <td>
    ...
    <tr>
      <td>
        <a href="/docs/reference/query-language/statements/define/module">
          DEFINE MODULE
        </a>
      </td>
      <td>
        <code>surrealism</code>
      </td>
    </tr>
  </tbody>
</table>
