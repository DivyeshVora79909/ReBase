...
<table>
  ...
  <tbody>
    <tr>
      <td scope="row" data-label="Specifier">
        %Y
      </td>
      <td scope="row" data-label="Example">
        2001
      </td>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description">
        Day of the week. Monday = 1, Tuesday = 2, ..., Sunday = 7. ([RFC
    ...
    <tr>
      ...
      <td scope="row" data-label="Description">
        Same as %U, but week 1 starts with the first Monday in that year
        instead.
      </td>
    </tr>
    <tr>
      ...
      <td scope="row" data-label="Description">
        Same as %Y but uses the year number in [RFC
        3339](https://datatracker.ietf.org/doc/html/rfc3339) week date.
      </td>
    </tr>
    <tr>
      <td scope="row" data-label="Specifier">
    ...
    <tr>
      ...
      <td scope="row" data-label="Description">
        Same as %U but uses the week number in [RFC
        3339](https://datatracker.ietf.org/doc/html/rfc3339) week date (01 to
        53).
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description">
        Year-month-day format ([RFC
        3339](https://datatracker.ietf.org/doc/html/rfc3339)). Same as %Y-%m-%d.
      </td>
    </tr>
    <tr>
      <td scope="row" data-label="Specifier">
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td scope="row" data-label="Description">
        [RFC 3339](https://datatracker.ietf.org/doc/html/rfc3339) / RFC 3339
        date &amp; time format.
      </td>
    </tr>
    <tr>
