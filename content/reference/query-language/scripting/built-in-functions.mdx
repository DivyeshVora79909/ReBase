...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Full fledged fetch implementation closely matching the{" "}
    ...
    <tr>
      ...
      <td>
        Retrieve values for SurrealQL variables from within the embedded
        scripting functions.
      </td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="2">
        Accepts various options related to the request. Refer to MDN docs for a
        full reference.
      </td>
    </tr>
  </tbody>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td colspan="2">Accepts the path to a variable</td>
    </tr>
  </tbody>
</table>
