...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#recordrefs">
          <code>record::refs()</code>
        </a>
      </td>
      <td scope="row" data-label="Description">
        Extracts and returns the record IDs of any records that have a record
        link along with a `REFERENCES` clause
      </td>
    </tr>
    <tr>
      <td scope="row" data-label="Function">
        <a href="#recordis_edge">
          <code>record::is_edge()</code>
        </a>
      </td>
      <td scope="row" data-label="Description">
