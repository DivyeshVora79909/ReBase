...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectordistancechebyshev">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectordistanceeuclidean">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectordistanceknn">
          <code>vector::distance::knn()</code>
        </a>
      </td>
      <td scope="row" data-label="Description">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectordistancemanhattan">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectordistanceminkowski">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectorsimilarityjaccard">
    ...
    <tr>
      <td scope="row" data-label="Function">
        <a href="#vectorsimilaritypearson">
